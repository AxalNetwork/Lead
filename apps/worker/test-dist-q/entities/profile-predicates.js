...
export const PREDICATE_MAP = Object.freeze(Object.fromEntries(PREDICATE_REGISTRY.map((p) => [p.predicate, p])));
export function getPredicateMeta(predicate) {
...
export const EMITTED_PREDICATES = Object.freeze([
