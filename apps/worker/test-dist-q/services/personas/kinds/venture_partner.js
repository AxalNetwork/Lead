...
export const venturePartnerPlugin = {
    ...
    defaultEntityFilter(persona, opts) {
        ...
        return {
            sql: `SELECT DISTINCT e.id FROM u_entities e
