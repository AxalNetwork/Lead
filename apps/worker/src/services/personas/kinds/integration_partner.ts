// Task #3: thin plugin wrapper for kind=integration_partner. Delegates to the
...
export const IntegrationPartnerPlugin: KindCriteriaPlugin = makeGenericPlugin("integration_partner");
