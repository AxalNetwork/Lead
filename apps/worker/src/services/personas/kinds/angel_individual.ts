// Task #3: thin plugin wrapper for kind=angel_individual. Delegates to the
...
export const AngelIndividualPlugin: KindCriteriaPlugin = makeGenericPlugin("angel_individual");
