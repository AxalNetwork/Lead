// Task #3: thin plugin wrapper for kind=service_provider. Delegates to the
...
export const ServiceProviderPlugin: KindCriteriaPlugin = makeGenericPlugin("service_provider");
