// Task #3: thin plugin wrapper for kind=government_grant_officer. Delegates to the
...
export const GovernmentGrantOfficerPlugin: KindCriteriaPlugin = makeGenericPlugin("government_grant_officer");
