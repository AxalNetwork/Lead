// Task #3: thin plugin wrapper for kind=academic_researcher. Delegates to the
...
export const AcademicResearcherPlugin: KindCriteriaPlugin = makeGenericPlugin("academic_researcher");
