// Task #3: thin plugin wrapper for kind=design_partner. Delegates to the
...
export const DesignPartnerPlugin: KindCriteriaPlugin = makeGenericPlugin("design_partner");
