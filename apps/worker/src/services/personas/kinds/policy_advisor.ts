// Task #3: thin plugin wrapper for kind=policy_advisor. Delegates to the
...
export const PolicyAdvisorPlugin: KindCriteriaPlugin = makeGenericPlugin("policy_advisor");
