// Task #3: thin plugin wrapper for kind=journalist_analyst. Delegates to the
...
export const JournalistAnalystPlugin: KindCriteriaPlugin = makeGenericPlugin("journalist_analyst");
