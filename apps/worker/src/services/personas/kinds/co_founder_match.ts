// Task #3: thin plugin wrapper for kind=co_founder_match. Delegates to the
...
export const CoFounderMatchPlugin: KindCriteriaPlugin = makeGenericPlugin("co_founder_match");
