// Task #3: thin plugin wrapper for kind=engineering_hire. Delegates to the
...
export const EngineeringHirePlugin: KindCriteriaPlugin = makeGenericPlugin("engineering_hire");
