// Task #3: thin plugin wrapper for kind=limited_partner. Delegates to the
...
export const LimitedPartnerPlugin: KindCriteriaPlugin = makeGenericPlugin("limited_partner");
