// Task #3: thin plugin wrapper for kind=channel_partner. Delegates to the
...
export const ChannelPartnerPlugin: KindCriteriaPlugin = makeGenericPlugin("channel_partner");
