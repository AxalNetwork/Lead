...
(function () {
  ...
  function fetchUnread() {
    return window.adsUtil.request(apiUrl("/api/alerts/unread-count"), { credentials: "include" })
  ...
  function openDropdown() {
    ...
    window.adsUtil.request(apiUrl("/api/alerts/events?limit=20"), { credentials: "include" })
  ...
  list.addEventListener("click", function (e) {
    ...
    window.adsUtil.request(apiUrl("/api/alerts/events/" + encodeURIComponent(id) + "/read"),
  ...
  if (readAll) {
    readAll.addEventListener("click", function (e) {
      e.preventDefault();
      window.adsUtil.request(apiUrl("/api/alerts/events/read-all"), { method: "POST", credentials: "include" })
